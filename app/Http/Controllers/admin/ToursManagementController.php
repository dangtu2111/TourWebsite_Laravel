...
class ToursManagementController extends Controller
{
    ...
    public function addImagesTours(Request $request)
    {
        try {
            ...
            return response()->json(['error' => false, 'message' => 'Failed to save image data'], 500);
        } catch (\Exception $e) {
            // Xử lý lỗi bất ngờ
    ...
    public function uploadTempImagesTours(Request $request)
    {
        try {
            ...
            return response()->json(['error' => false, 'message' => 'Failed to save image data'], 501);
        } catch (\Exception $e) {
            // Xử lý lỗi bất ngờ
            return response()->json(['error' => false, 'message' => $e->getMessage()], 900);
        }
    }
