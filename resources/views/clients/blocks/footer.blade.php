                ...
                <div class="col col-md-6 col-10 col-small" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                    <div class="footer-widget footer-contact">
                        ...
                        <ul class="list-style-one">
                            <li><i class="fal fa-map-marked-alt"></i> 144/16 Au Co ,Tan Binh ,HCM</li>
                            <li><i class="fal fa-envelope"></i> <a
                                    href="mailto:minhdien.dev@gmail.com">anhtuhanam1@gmail.com</a></li>
...
<!--End pagewrapper-->
    ...
    {{-- paypal-payment  --}}
    <script src="https://www.paypal.com/sdk/js?client-id=AS4ZOdcCWErZNck8bFjRdwtWWK_sCBYkGD7pqid9S14vo9VEk4d_Vu8gerZgiEGy0aa9LCVaaPHU8S8k"></script>
